...
//	WebView myWebView = (WebView) findViewById(R.id.webview);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) 
            {
                SharedPreferences prefs = PreferenceManager
                	    .getDefaultSharedPreferences(Tab2Activity.this);

            	String user = prefs.getString("t2_user", "");
            	String pass = prefs.getString("t2_pass", "");
        ...
        SharedPreferences prefs = PreferenceManager
        	    .getDefaultSharedPreferences(Tab2Activity.this);
        String tab_text = prefs.getString("t2_name", "Default Tab");
        String url = prefs.getString("t2_url", "testing.novopay.in");
        

        MainActivity activity = (MainActivity) this.getParent();
    	final TabHost host = activity.getTabHost();
    	TextView tv = (TextView) host.getTabWidget().getChildAt (1).findViewById (android.R.id.title);
    	tv.setText(tab_text);
    ...
    protected void onResume() {
        ...
        SharedPreferences prefs = PreferenceManager
        	    .getDefaultSharedPreferences(Tab2Activity.this);
        String tab_text = prefs.getString("t2_name", "Default Tab");
        String url = prefs.getString("t2_url", "live.novopay.in");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.url:
        	Intent intent = new Intent(Tab2Activity.this,
  		      PrefsActivity.class);
